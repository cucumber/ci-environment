...
class VariableExpressionTest {
    @Test
    void it_returns_null_when_a_variable_is_undefined() {
    ...
    @Test
    void it_gets_a_value_without_replacement() {
    ...
    @Test
    void it_escapes_a_value_without_replacement() {
        String expression = "${SOME_VAR}";
    ...
    @Test
    void it_works_with_star_wildcard_in_var() {
    ...
    @Test
    void it_evaluates_a_complex_expression() {
    ...
    @Test
    void it_escapes_a_complex_expression() {
        String expression = "hello-${VAR1}-${VAR2/(.*) (.*)/\\2-\\1}-world";
        String result = evaluate(expression, Map.of(
                "VAR1", "${VAR1}",
                "VAR2", "${VAR2a} ${VAR2b}"
